 ...
 * 
 * Comments:
 * This sketch demonstrates the operation of a resistive touchscreen.
...
void setup()
{
    ...
    Serial.println("Arduino TFT_shield Example_02!");
...
#ifdef EKA_TFT_VER_1 // Keyboard only for EKA_TFT_VER_1
    ScanKey();
#endif
}
